...
<script type="text/javascript" src="<?php echo path_homeTheme; ?>js/responsive-nav.js"></script>
<!----search-scripts---->
<script src="<?php echo path_homeTheme; ?>js/classie.js"></script>
<script src="<?php echo path_homeTheme; ?>js/uisearch.js"></script>
<script>
...
<script src="<?php echo path_homeTheme; ?>js/demo-js/datatables-demo.js"></script>